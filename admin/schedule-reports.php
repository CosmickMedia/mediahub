...
?>
    ...
    <style>
        ...
        .tom-select.multi .ts-control > div {
            ...
            <form method="get" id="filterForm">
                <div class="filter-grid">
                    ...
                    <div class="filter-group" style="min-width: 250px;">
                        ...
                        <select name="store[]" id="store-select" class="form-select-modern" multiple>
                    ...
                    <div class="filter-group" style="min-width: 200px;">
                        ...
                        <select name="network[]" id="network-select" class="form-select-modern" multiple>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Initialize Tom Select for better multi-select with updated selectors
