...
- All email configuration now consolidated in one location for easier setup

## [2.4.1] - 2026-01-26
### Fixed
- What's New modal not dismissing when closed via X button, backdrop click, or ESC key
- Modal dismiss state now shared across browser tabs (switched from sessionStorage to localStorage)

## [2.4.0] - 2025-12-28
### Changed
- Redesigned Broadcasts page with improved visual hierarchy
- Enhanced store selector with styled pills and better contrast
- Improved broadcast message cards with shadows and colored borders
- Made action buttons (Edit/Delete) more visible with proper colors
- Added clear section separation between Compose and History areas
### Fixed
- Action button visibility issue (grey on grey)
